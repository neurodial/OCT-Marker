...
public:
	...
	virtual void drawBScanSLOCircle(QPainter&, int /*bscanNr*/, const OctData::CoordSLOpx& /*start_px*/, const OctData::CoordSLOpx& /*center_px*/, SLOImageWidget*) const override;
